...
export default function Contact() {
  return <>
    ...
    <div className=' pb-5'>
    <h2 className='font-bold uppercase text-5xl'>conatct section</h2>
    </div>
    ...
    <div className='lg:w-[500px] sm:w-[400px] mx-auto mt-5'>
    <div className="relative w-full mb-5 group">
        ...
        <div className="relative w-full mb-5 group">
            ...
            <label for="floating_name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">User Age</label>
        </div>
